  ...
  return (
    <>
        ...
        <div className="carousel-inner">
            ...
            <div className="carousel-item">
            <img src="https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/4recorte.jpg?alt=media&token=aa7d63f8-27f1-4ff8-8dc8-e56c59e020ea" className="d-block w-100" alt="..."/>
            </div>
            <div className="carousel-item">
            <img src="https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/5recorte.jpg?alt=media&token=943088bb-9e2a-4ff4-b084-7931330c8951" className="d-block w-100" alt="..."/>
            </div>
        </div>
