          ...
          <div className={litleImgSoo? "backSoo": "backSooBig"}>
            ...
            <div className="orgSoo">
              ...
              <div className="aroundSoo">
                  ...
                  <div className="aroundPeopleSoo">
                    <div className="groupS">
                      <strong>Comisión de SOOFMA</strong>
                      <br></br>
                      (Sociedad de Ortodoncia y Ortopedia Funcional de los Maxilares)
                    </div>
                    <div className="groupS">Rama San Luis de la <strong>SAO</strong> (Sociedad Argentina de Ortodoncia) </div>
                    <div className="groupS"><strong>Presidente:</strong> Dr. Darío Capellino</div>
                    <div className="groupS"><strong>Secretaria:</strong> Dra. Yanina Manso</div>
                    <div className="groupS"><strong>Tesorera:</strong> Dra. Guadalupe Gonzalez</div>
                    <div className="groupS"><strong>Primer Vocal:</strong> Dr. Raul Bertone</div> 
                    <div className="groupS"><strong>Segundo Vocal:</strong> Dra.María Eugenia Borra</div>
                    <div className="groupS"><strong>Primer vocal suplente:</strong> Dr.Darío Ramis</div> 
                    <div className="groupS"><strong>Segundo vocal suplente:</strong> Dra. Belen Canta.</div>
                    </div>
                    </div>
              <div className="logoSoo">
                    <img src={logoS} alt="" className='logoSoofma'/>
