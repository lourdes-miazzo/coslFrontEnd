                ...
                <div className="aroundSoo">
                  <span className="textSoo">
                    ...
                    <p className="indTextSoo">
                      ...
                      Las principales funciones son: la especialización académica, la función social y asesoramiento en 
                    ...
                    <p className="indTextSoo">
                      -Acceso a la revista de ortodoncia de la SAO de distribución semestral, la cual cuenta con artículos 
