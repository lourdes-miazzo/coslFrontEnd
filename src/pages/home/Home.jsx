            ...
            <div className="backColor4">
                <div className="centerPiece">
                    ...
                    <div className="logosHome">
                        ...
                        <Link to="https://www.instagram.com/circulo.odontologicodesanluis?igsh=MXQ3aXdqOTkzN21ibg==" target='_blank' style={{textDecoration:"none", color: "inherit"}}><img src={logoI} className="logoIndHome"/></Link>
                    </div>
                </div>
            </div>
        <Footer/>
