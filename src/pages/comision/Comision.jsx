        ...
        <>
            <div className={litleImg ?"backColor1" : "backColorBig1"}>
                ...
                <div className="logosPeople">
                        ...
                        <Link to="https://www.instagram.com/circulo.odontologicodesanluis?igsh=MXQ3aXdqOTkzN21ibg==" target='_blank' style={{textDecoration:"none", color: "inherit"}}><img src={logoI} className="logoIndPeople"/></Link>
                    </div>
            </div>
            <Footer/>
        </>
