        ...
        <>
            <div className={litleImgStudies? "backStudies": "backStudiesBig"}>
                ...
                <div className="logosStudies">
                        <Link to="https://www.facebook.com/circuloodontologicosanluis.org" target='_blank' style={{textDecoration:"none", color: "inherit"}}><img src={logoF} className="logoIndStudies"/></Link>
                        ...
                        <Link to="https://www.instagram.com/cosl.ep/" target='_blank' style={{textDecoration:"none", color: "inherit"}}><img src={logoI} className="logoIndStudies"/></Link>
                    </div>
            </div>
            <Footer/>
        </>
