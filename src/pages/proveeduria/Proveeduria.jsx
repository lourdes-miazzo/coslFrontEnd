        ...
        <div className="backColorSuplie">
            <div className="aroundSuplie">
                ...
                <div className="whatsAreaSuplie">
                    ...
                    <Link to="https://api.whatsapp.com/send?phone=5492665133187" target='_blank' style={{textDecoration:"none", color: "inherit"}}><img src={logoW} className="logoWhatsSuplie"/></Link>
                </div>
            </div>
        </div>
        <Footer/>
