              ...
              <div className="orgCour">
                <div className="aroundCour">
                  <span className="textCour">
                    ...
                    <p className="indTextCour">
                      <span className="pointTextCour">.</span>
                      Ortodoncia MBT teórico práctico con clínica sobre pacientes de nivel inicial y media. A cargo del Dr. Ricardo Abratte
                    </p>
                    
                    <p className="indTextCour">
                      <span className="pointTextCour">.</span>
                      Actualizaciones de estomatología. A cargo del Dr. Angel Daniel Talavera
                    </p>
                  
                    <p className="indTextCour">
                      <span className="pointTextCour">.</span>
                      Rehabilitación bucal integral en la era digital con prótesis implanto asistida. A cargo de la Dr, Rodriguez Alejandro
                    </p>
